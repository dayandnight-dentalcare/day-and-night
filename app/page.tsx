...
const DOCTORS = [
  { name: "Dr. Killamsetty Sai Sandeep", role: "MDS Orthodontist", image: "https://ui-avatars.com/api/?name=Dr+Sandeep&background=2CBCE4&color=fff&size=400&font-size=0.3" },
...
export default function Home() {
  return (
    <div className="flex flex-col w-full pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-white/70 text-lg md:text-xl max-w-lg leading-relaxed font-light">
                Experience luxury healthcare tailored to your unique smile goals. We bring artistry and advanced digital techniques together.
              </p>
      ...
      <section className="py-20 relative z-20 mt-12 md:mt-0">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 md:-mt-24 lg:-mt-32">
            <AnimatedCard delay={0.1} className="p-8 bg-dark-800/80 backdrop-blur-xl border border-white/5 h-full flex flex-col justify-between">
              <div>
                <Search className="w-12 h-12 text-gold mb-6" />
            ...
            <AnimatedCard delay={0.2} className="relative p-1 bg-gradient-to-b from-primary via-accent/50 to-dark-800 h-full flex flex-col justify-between transform md:-translate-y-6 shadow-[0_30px_60px_-15px_rgba(44,188,228,0.3)] hover:-translate-y-8 transition-transform z-10">
              <div className="bg-dark-900 rounded-[15px] p-8 h-full flex flex-col justify-between border-t border-accent/30 inset-0">
                ...
                <Link href="/appointment" className="w-full py-3 bg-white text-dark-900 font-bold text-center rounded-lg hover:bg-gold transition-colors flex items-center justify-center gap-2">
      ...
      <section className="py-24 border-t border-white/5 relative overflow-hidden">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          >
            <h2 className="text-sm font-bold tracking-[0.3em] text-gold uppercase mb-4">The Ultimate Sense of Beauty</h2>
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-10 font-light">
              At Day & Night Dental Clinic, we believe a confident smile is your greatest asset. Our state-of-the-art facility combines precision medical technology with a luxury concierge experience to design the perfect smile tailored uniquely for you.
            </p>
            <Link href="/about" className="inline-flex flex-col group items-center">
              <span className="text-sm uppercase tracking-widest font-medium text-white group-hover:text-gold transition-colors">Our Story</span>
              <div className="w-12 h-[1px] bg-white/30 mt-2 group-hover:bg-gold group-hover:w-16 transition-all duration-300" />
            </Link>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16">
            <div>
              ...
              <h3 className="font-heading text-4xl md:text-5xl font-bold">Our Services</h3>
            </div>
            <Link href="/specialities" className="hidden md:flex items-center text-gold hover:text-white transition-colors">
          ...
          <div className="mt-12 text-center w-full flex justify-center">
            <Link href="/specialities" className="inline-flex items-center justify-center px-8 py-3 border border-gold text-gold hover:bg-gold hover:text-dark-900 font-bold rounded-full transition-all duration-300">
              Show More
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 overflow-hidden border-t border-white/5">
        <div className="container mx-auto px-6 max-w-7xl text-center mb-16">
          <h2 className="text-gold text-sm font-bold tracking-widest uppercase mb-2">Master Clinicians</h2>
            ...
            <div key={idx} className="w-[300px] flex-shrink-0 group relative overflow-hidden rounded-2xl glass">
              <div className="aspect-[4/5] relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-dark-900 via-dark-900/80 to-transparent z-20">
                  <h4 className="font-heading text-xl font-bold text-white mb-1 group-hover:text-gold transition-colors">{doc.name}</h4>
      ...
      <section className="py-24 bg-dark-800/30 border-t border-white/5">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 max-w-2xl mx-auto">Witness the art of transformation. Real patients, real luxury results.</p>
          </div>
          ...
          <div className="mt-12 text-center">
            <Link href="/gallery" className="inline-block border-b border-gold text-gold hover:text-white hover:border-white pb-1 transition-all">
          ...
          <div className="glass rounded-[40px] p-12 md:p-20 text-center relative overflow-hidden border border-white/10 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/70 text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
                Join our exclusive network of patients who have unlocked their ultimate sense of beauty. Schedule an initial consultation today.
              </p>
              <Link href="/appointment" className="inline-flex items-center justify-center px-10 py-5 bg-white text-dark-900 rounded-full font-bold hover:bg-gold transition-colors duration-300 text-lg shadow-[0_0_30px_rgba(255,255,255,0.15)] group">
