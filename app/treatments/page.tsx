                    ...
                    {expandedIndex === idx && (
                      ...
                      >
                        <div className="pt-4 border-t border-gray-100">
                          ...
                          <div className="mt-4 flex items-start sm:items-center gap-2 text-teal-900 bg-teal-50/80 p-3 rounded-lg border border-teal-100 shadow-sm">
                            <Tag size={16} className="flex-shrink-0 text-teal-600 mt-0.5 sm:mt-0" />
                            <span className="font-medium text-sm leading-tight">
                              Estimated Price Range: {service.price}
                            </span>
                          </div>
                        </div>
                      </motion.div>
